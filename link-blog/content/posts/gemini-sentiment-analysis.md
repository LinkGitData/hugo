...
mermaid: true
cover:
  image: "images/gemini-cover.png?v=1"
  alt: "Gemini 情感分析"
  caption: "Powered by Gemini 2.5 Flash Lite"
  relative: false
---
...
graph LR
    ...
    subgraph AI Processing
        ...
        Vertex -->|Prompt 提示詞| Gemini[Gemini 2.5 Flash Lite 模型]
        Gemini -->|JSON 回應| App
    end
...
首先，我們使用 `vertexai.preview.generative_models` 函式庫來載入 **Gemini 2.5 Flash Lite** 模型。請注意我們給予 AI 一個「評論家」的角色設定。
